...
[![Codecov test coverage](https://codecov.io/gh/Dynamo-HIA/hiaR/graph/badge.svg)](https://app.codecov.io/gh/Dynamo-HIA/hiaR)
<!-- badges: end -->
...
Before making a release, please change the default value for the `release_tag` argument in the `download_github_release` function to the tag of the new release.
